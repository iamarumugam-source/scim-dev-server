...
// ─── ARCHIVED ─────────────────────────────────────────────────────────────────
//
// The previous dashboard, superseded by /scim. Kept as an unlinked route so it stays
...
// covers it.
//
// Nothing imports this file. To roll back, move it over /scim (its git history
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex items-start gap-2.5 rounded-lg border border-dashed px-3.5 py-2.5 text-xs text-muted-foreground">
        ...
        <span>
          <strong className="text-foreground">Archived dashboard.</strong> Kept for
          comparison and rollback only — not linked from navigation. The current
          dashboard lives at <code className="font-mono">/scim</code>.
        </span>
      </div>
