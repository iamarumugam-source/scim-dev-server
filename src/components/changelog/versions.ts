import type { Version } from "./version-block";

// ─── Changelog data ───────────────────────────────────────────────────────────
// Split out of the page so the page can be a client component (the type filter
// and search need state) without the data definition sitting inside it.
